        ...
        TinyLoader.setup(function (editor, onSuccess, onFailure) {
            Pipeline.async({}, [
                ...
                Logger.t('Paste pre/post process alter on preprocess/postprocess', Chain.asStep(editor, [
                    ...
                    Assertions.cAssertEq('Should have all b elements removed and have a X added', {
                        content: 'abcX',
                        cancelled: false
                    })
                ])),
                ...
                Logger.t('Paste pre/post process prevent default on preProcess', Chain.asStep(editor, [
                    ...
                    Assertions.cAssertEq('Should have all b elements removed and be cancelled', {
                        content: 'a<b>b</b>c',
                        cancelled: true
                    })
                ])),
                ...
                Logger.t('Paste pre/post process prevent default on postProcess', Chain.asStep(editor, [
                    ...
                    Assertions.cAssertEq('Should have a X added and be cancelled', {
                        content: 'a<b>b</b>cX',
                        cancelled: true
                    })
                ]))
