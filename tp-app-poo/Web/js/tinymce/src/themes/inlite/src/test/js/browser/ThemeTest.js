asynctest(
    ...
    ], function (Chain, FocusTools, GeneralSteps, Mouse, Pipeline, UiControls, UiFinder, Waiter, TinyActions, TinyApis, TinyDom, TinyLoader, ContextMenuPlugin, ImagePlugin,
