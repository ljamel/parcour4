asynctest(
    'browser.tinymce.core.InsertContentCommandTest',
    [
    ...
    function (Pipeline, LegacyUnit, TinyLoader, Env, JSON, Theme) {
        ...
        suite.test('mceInsertContent - span in span same style color', function (editor) {
            ...
            editor.execCommand('mceInsertContent', false, {
                content: '<span style="color:#ff0000">b</span>',
                merge: true
            });
        ...
        suite.test('mceInsertContent - span in span different style color', function (editor) {
            ...
            LegacyUnit.setSelection(editor, 'span', 1);
            editor.execCommand('mceInsertContent', false, {
                content: '<span style="color:#00ff00">b</span>',
                merge: true
            });
