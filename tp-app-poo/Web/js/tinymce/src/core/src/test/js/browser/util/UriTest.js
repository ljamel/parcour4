asynctest(
    'browser.tinymce.core.util.UriTest',
    [
        'ephox.mcagar.api.LegacyUnit',
        'ephox.agar.api.Pipeline',
        'tinymce.core.util.URI'
    ],
    function (LegacyUnit, Pipeline, URI) {
        ...
        suite.test('getDocumentBaseUrl', function () {
            ...
            LegacyUnit.equal(getDocumentBaseUrl({
                protocol: 'file:',
                host: '',
                pathname: '/dir/path1/path2'
            }), 'file:///dir/path1/');
            LegacyUnit.equal(getDocumentBaseUrl({
                protocol: 'http:',
                host: 'localhost',
                pathname: '/dir/path1/path2'
            }), 'http://localhost/dir/path1/');
            LegacyUnit.equal(getDocumentBaseUrl({
                protocol: 'https:',
                host: 'localhost',
                pathname: '/dir/path1/path2'
            }), 'https://localhost/dir/path1/');
            LegacyUnit.equal(getDocumentBaseUrl({
                protocol: 'https:',
                host: 'localhost',
                pathname: '/dir/path1/path2/'
            }), 'https://localhost/dir/path1/path2/');
            LegacyUnit.equal(getDocumentBaseUrl({
                protocol: 'http:',
                host: 'localhost:8080',
                pathname: '/dir/path1/path2'
            }), 'http://localhost:8080/dir/path1/');
            LegacyUnit.equal(getDocumentBaseUrl({
                protocol: 'http:',
                host: 'localhost',
                pathname: '/dir/path1/path2/file.html'
            }), 'http://localhost/dir/path1/path2/');
            LegacyUnit.equal(getDocumentBaseUrl({
                protocol: 'http:',
                host: 'localhost',
                pathname: '/'
            ...
            LegacyUnit.equal(getDocumentBaseUrl({
                ...
                href: 'applewebdata://something//dir/path1#hash'
            }), 'applewebdata://something//dir/');
            LegacyUnit.equal(getDocumentBaseUrl({
                protocol: 'applewebdata:',
                href: 'applewebdata://something//dir/path1'
            }), 'applewebdata://something//dir/');
        });
