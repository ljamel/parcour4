define(
    ...
    function (Assertions, DOMUtils) {
        ...
        var loadSkinAndOverride = function (viewBlock, done) {
            ...
            DOMUtils.DOM.styleSheetLoader.load('/project/src/skins/lightgray/dist/lightgray/skin.min.css', function () {
                DOMUtils.DOM.styleSheetLoader.load('/project/src/core/src/test/css/ui-overrides.css', done);
            });
        };
