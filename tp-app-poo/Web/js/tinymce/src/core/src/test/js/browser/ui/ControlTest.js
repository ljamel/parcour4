asynctest(
    ...
    function (Pipeline, LegacyUnit, DOMUtils, EventUtils, EditorManager, UiUtils, ViewBlock, Api, Container, Control, Tools) {
        ...
        suite.test("Properties", function () {
            ...
            // Set all states
            ctrl = ctrl.disabled(true).active(true).visible(true).text("Text").title("Title").name("Name").parent(cont);
        ...
        suite.test("Chained methods", function () {
            ...
            // Set all states
            ctrl = ctrl.on('click', function () {
            }).off().renderTo(viewBlock.get()).remove();
